...
public class Issue extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 240, -1));

        jLabel2.setFont(new java.awt.Font("Tempus Sans ITC", 1, 24)); // NOI18N
        jLabel2.setText("STUDENT ID            :");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 200, 230, -1));
        ...
        getContentPane().add(bid, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 122, 270, 30));

        studid.setText("  ");
        getContentPane().add(studid, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 200, 270, 30));
        getContentPane().add(issued, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 272, 270, 30));
        getContentPane().add(dued, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 342, 270, 30));

        jLabel5.setFont(new java.awt.Font("Tempus Sans ITC", 1, 36)); // NOI18N
        jLabel5.setText("ISSUE BOOK ");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 40, 220, 30));

        jLabel6.setIcon(new javax.swing.ImageIcon("C:\\Users\\nancy\\Music\\IMG_20230513_214807.jpg")); // NOI18N
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 650, 500));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         String sid1 = studid.getText();
         String isd1= issued.getText();
         String dd1 = dued.getText();
         String rt="null";
    ...
    try(Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/jdbcexam","root","samyu_park")) {
        ...
        String sql = "insert into issue1 values('"+bid1+"','"+sid1+"','"+isd1+"','"+dd1+"','"+rt+"')";
